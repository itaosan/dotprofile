...
- 計画提示前に致命点レビューを1回以上通すこと（必須）
- レビュー指示の文章は適宜調整すること。「瑣末な点へのクソリプはしない。致命的な点のみ指摘しろ。」という指示は必ず入れること。
- レビュー指摘がなくなるまで、アップデート → レビューを繰り返すこと。

### [Claude Code]

- `/codex` Skill でレビューを行う
- 使用不可の場合はスキップしてよい

### [Codex CLI]

- 計画提示前に自己レビューを必須実施する
- ユーザー確認はレビュー後の承認手続きであり、レビューの代替には使わない
